...
public final class Base64 {
	...
	private static byte[] base64Alphabet = new byte[Base64.BASELENGTH];
	private static byte[] lookUpBase64Alphabet = new byte[Base64.LOOKUPLENGTH];

	static {
		for (int i = 0; i < Base64.base64Alphabet.length; i++)
