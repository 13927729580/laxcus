...
public class SQLAbout extends JDialog implements ActionListener {
	 ...
	 */
	public SQLAbout(Frame owner, boolean modal) throws HeadlessException {
		super(owner, modal);
	}
	...
	private JPanel initPane() {
		...
		try {
			...
			java.net.URL url = loader.findURL("conf/terminal/html/window/about.html");
