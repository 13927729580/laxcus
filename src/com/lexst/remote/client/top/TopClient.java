...
public class TopClient extends RemoteClient implements TopVisit {
	...
	private static Method methodFindSchema;
	...
	private static Method methodOnUser;
	...
	private static Method methodSetRebuildTime;
	...
	private static Method methodShowTask;
	...
	static {
		try {
			...
			methodFindSchema = (TopVisit.class).getMethod("findSchema", new Class<?>[] { SiteHost.class, String.class });
			...
			methodOnUser = (TopVisit.class).getMethod("onUser", new Class<?>[]{SiteHost.class, String.class});
			...
			methodSetRebuildTime = (TopVisit.class).getMethod("setRebuildTime", new Class<?>[] { String.class, String.class, Short.TYPE, Integer.TYPE, Long.TYPE });
			
			methodRebuild = (TopVisit.class).getMethod("rebuild", new Class<?>[] { SiteHost.class, String.class, String.class, Short.TYPE, Address[].class });
			methodLoadIndex = (TopVisit.class).getMethod("loadIndex", new Class<?>[] { SiteHost.class, String.class, String.class, Address[].class });
			methodStopIndex = (TopVisit.class).getMethod("stopIndex", new Class<?>[] { SiteHost.class, String.class, String.class, Address[].class });
			methodLoadChunk = (TopVisit.class).getMethod("loadChunk", new Class<?>[] { SiteHost.class, String.class, String.class, Address[].class });
			methodStopChunk = (TopVisit.class).getMethod("stopChunk", new Class<?>[] { SiteHost.class, String.class, String.class, Address[].class });
			
			methodBuildTask = (TopVisit.class).getMethod("buildTask", new Class<?>[] { SiteHost.class, String.class, Address[].class });

			methodShowChunkSize1 = (TopVisit.class).getMethod("showChunkSize", new Class<?>[] { SiteHost.class, String.class, Integer.TYPE, Address[].class });
			methodShowChunkSize2 = (TopVisit.class).getMethod("showChunkSize", new Class<?>[] { SiteHost.class, String.class, String.class, Integer.TYPE, Address[].class });
			methodShowTask = (TopVisit.class).getMethod("showTask", new Class<?>[] { SiteHost.class, String.class, Address[].class });
			
			methodShowSite = (TopVisit.class).getMethod("showSite", new Class<?>[] { Integer.TYPE, Address[].class });
	 ...
	 * 
	 * @param stream - 流模式连接
	 * @param address  - 服务器主机域名或者IP地址
	 * @param port - 服务器端口
	 * @throws UnknownHostException
	 */
	public TopClient(boolean stream, String address, int port) throws UnknownHostException{
		this(stream);
		super.setRemote(InetAddress.getByName(address), port);
	}
	 ...
	 */
	@Override
	public Number[] pullKey(String schema, String table, int num) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { schema, table, new Integer(num)};
	...
	public boolean setChunkSize(String schema, String table, int size) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { schema, table, new Integer(size) };
	 ...
	 */
	@Override
	public SiteHost[] selectCallSite(String naming, String schema, String table) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { naming, schema, table };
	...
	public Schema findSchema(SiteHost local, String schema) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, schema };
		Object param = super.invoke(methodFindSchema, params);
		return (Schema)param;
	}
	 ...
	 */
	@Override
	public boolean deleteSchema(SiteHost local, String schema) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, schema};
	...
	public boolean deleteUser(SiteHost local, String username) throws VisitException {
		...
		Object param = super.invoke(TopClient.methodDeleteUser, params);
		return ((Boolean) param).booleanValue();
	}
	...
	public boolean alterUser(SiteHost local, User user) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, user };
		Object param = super.invoke(TopClient.methodAlterUser, params);
		return ((Boolean) param).booleanValue();
	}
	...
	public boolean onUser(SiteHost local, String username) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, username };
		Object param = super.invoke(TopClient.methodOnUser, params);
		return ((Boolean) param).booleanValue();
	}
	...
	public boolean addPermit(SiteHost local, Permit permit) throws VisitException {
		...
		Object param = super.invoke(TopClient.methodAddPermit, params);
		return ((Boolean)param).booleanValue();
	}
	 ...
	 */
	@Override
	public Table findTable(SiteHost local, String schema, String table) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, schema, table };
	 ...
	 * @throws VisitException
	 */
	public Table findTable(SiteHost local, Space space) throws VisitException {
		return this.findTable(local, space.getSchema(), space.getTable());
	}
	...
	public boolean setRebuildTime(String schema, String table, short columnId, int type, long time) throws VisitException {
		...
		Object[] params = new Object[] { schema, table, new Short(columnId),
				new Integer(type), new Long(time) };
		Object param = super.invoke(methodSetRebuildTime, params);
		return ((Boolean) param).booleanValue();
	}
	 ...
	 * @throws VisitException
	 */
	public Address[] rebuild(SiteHost local, Space space, short columnId, Address[] addresses) throws VisitException {
		return rebuild(local, space.getSchema(), space.getTable(), columnId, addresses);
	}
	
	/*
	 * 通知TOP节点，重构某个表，包括指定键和DATA节点地址
	 * @see com.lexst.visit.naming.top.TopVisit#rebuild(com.lexst.util.host.SiteHost, java.lang.String, java.lang.String, short, java.lang.String[])
	 */
	@Override
	public Address[] rebuild(SiteHost local, String schema, String table, short columnId, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, schema, table, new Short(columnId), addresses };
		Object param = super.invoke(methodRebuild, params);
	 ...
	 * @throws VisitException
	 */
	public Address[] loadIndex(SiteHost local, Space space, Address[] addresses) throws VisitException {
		return loadIndex(local, space.getSchema(), space.getTable(), addresses);
	}
	 ...
	 */
	@Override
	public Address[] loadIndex(SiteHost local, String schema, String table, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, schema, table, addresses };
	 ...
	 * @throws VisitException
	 */
	public Address[] stopIndex(SiteHost local, Space space, Address[] addresses) throws VisitException {
		return stopIndex(local, space.getSchema(), space.getTable(), addresses);
	}
	 ...
	 */
	@Override
	public Address[] stopIndex(SiteHost local, String schema, String table, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, schema, table, addresses };
	 ...
	 * @throws VisitException
	 */
	public Address[] loadChunk(SiteHost local, Space space, Address[] addresses) throws VisitException {
		return loadChunk(local, space.getSchema(), space.getTable(), addresses);
	}
	 ...
	 */
	@Override
	public Address[] loadChunk(SiteHost local, String schema, String table, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, schema, table, addresses };
	 ...
	 * @throws VisitException
	 */
	public Address[] stopChunk(SiteHost local, Space space, Address[] addresses) throws VisitException {
		return stopChunk(local, space.getSchema(), space.getTable(), addresses);
	}
	 ...
	 */
	@Override
	public Address[] stopChunk(SiteHost local, String schema, String table, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, schema, table, addresses };
	 ...
	 */
	@Override
	public Address[] buildTask(SiteHost local, String naming, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, naming, addresses };
		Object param = super.invoke(methodBuildTask, params);
		return (Address[])param;
	}

	/* (non-Javadoc)
	 * @see com.lexst.visit.naming.top.TopVisit#showChunkSize(com.lexst.util.host.SiteHost, java.lang.String, int, java.lang.String[])
	 */
	@Override
	public long showChunkSize(SiteHost local, String schema, int siteType, Address[] sites) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, schema, new Integer(siteType), sites };
		Object param = super.invoke(methodShowChunkSize1, params);
		return ((Long) param).longValue();
	}

	/* (non-Javadoc)
	 * @see com.lexst.visit.naming.top.TopVisit#showChunkSize(com.lexst.util.host.SiteHost, java.lang.String, java.lang.String, int, java.lang.String[])
	 */
	@Override
	public long showChunkSize(SiteHost local, String schema, String table, int siteType, Address[] sites) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, schema, table, new Integer(siteType), sites };
		Object param = super.invoke(methodShowChunkSize2, params);
		return ((Long) param).longValue();
	}

	/* (non-Javadoc)
	 * @see com.lexst.visit.naming.top.TopVisit#findTask(com.lexst.util.host.SiteHost, java.lang.String, java.lang.String[])
	 */
	@Override
	public String showTask(SiteHost local, String tag, Address[] sites) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { local, tag, sites };
		Object param = super.invoke(methodShowTask, params);
		return (String)param;
	}
	...
	public SiteHost[] showSite(int site, Address[] froms) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { new Integer(site), froms };
