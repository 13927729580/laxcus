...
public class HomeClient extends RemoteClient implements HomeVisit {
	...
	private static Method methodSendCodePoints;
	private static Method methodFindCodePoints;
	...
	static {
		try {
			...
			methodRebuild = (HomeVisit.class).getMethod("rebuild", new Class<?>[] { String.class, String.class, Short.TYPE, Address[].class });
			methodLoadIndex = (HomeVisit.class).getMethod("loadIndex", new Class<?>[] { String.class, String.class, Address[].class });
			methodStopIndex = (HomeVisit.class).getMethod("stopIndex", new Class<?>[] { String.class, String.class, Address[].class });
			methodLoadChunk = (HomeVisit.class).getMethod("loadChunk", new Class<?>[] { String.class, String.class, Address[].class });
			methodStopChunk = (HomeVisit.class).getMethod("stopChunk", new Class<?>[] { String.class, String.class, Address[].class });
			
			methodBuildTask = (HomeVisit.class).getMethod("buildTask", new Class<?>[] { String.class, Address[].class });
			...
			methodShowChunkSize1 = (HomeVisit.class).getMethod("showChunkSize", new Class<?>[] { String.class, Integer.TYPE, Address[].class });
			methodShowChunkSize2 = (HomeVisit.class).getMethod("showChunkSize", new Class<?>[] { String.class, String.class, Integer.TYPE, Address[].class });
			methodShowTask = (HomeVisit.class).getMethod("showTask", new Class<?>[] { String.class, Address[].class });
			
			methodShowSite = (HomeVisit.class).getMethod("showSite", new Class<?>[] { Integer.TYPE });
			
			methodSendCodePoints = (HomeVisit.class).getMethod("sendCodePoints", new Class<?>[] { String.class, byte[].class });
			methodFindCodePoints = (HomeVisit.class).getMethod("findCodePoints", new Class<?>[] { String.class, String.class, java.lang.Short.TYPE });
	...
	/**
	 * @param address - 主机域名或者IP地址
	 * @param port
	 * @throws IOException
	 */
	public HomeClient(boolean stream, String address, int port) throws UnknownHostException {
		this(stream);
	...
	/*
	 * (non-Javadoc)
	 * @see com.lexst.visit.naming.home.HomeVisit#rebuild(java.lang.String, java.lang.String, short, com.lexst.util.host.Address[])
	 */
	@Override
	public Address[] rebuild(String schema, String table, short columnId, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { schema, table, new Short(columnId), addresses };
		Object param = super.invoke(HomeClient.methodRebuild, params);
	 ...
	 * @throws VisitException
	 */
	public Address[] loadIndex(Space space, Address[] addresses) throws VisitException {
		return loadIndex(space.getSchema(), space.getTable(), addresses);
	}
	
	/*
	 * (non-Javadoc)
	 * @see com.lexst.visit.naming.home.HomeVisit#loadIndex(java.lang.String, java.lang.String, com.lexst.util.host.Address[])
	 */
	@Override
	public Address[] loadIndex(String db, String table, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { db, table, addresses };
	 ...
	 * @throws VisitException
	 */
	public Address[] stopIndex(Space space, Address[] addresses) throws VisitException {
		return stopIndex(space.getSchema(), space.getTable(), addresses);
	}

	/*
	 * (non-Javadoc)
	 * @see com.lexst.visit.naming.home.HomeVisit#stopIndex(java.lang.String, java.lang.String, com.lexst.util.host.Address[])
	 */
	@Override
	public Address[] stopIndex(String schema, String table, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { schema, table, addresses };
	 ...
	 * @throws VisitException
	 */
	public Address[] loadChunk(Space space, Address[] addresses) throws VisitException {
		return loadChunk(space.getSchema(), space.getTable(), addresses);
	}

	/*
	 * (non-Javadoc)
	 * @see com.lexst.visit.naming.home.HomeVisit#loadChunk(java.lang.String, java.lang.String, com.lexst.util.host.Address[])
	 */
	@Override
	public Address[] loadChunk(String schema, String table, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { schema, table, addresses };
	 ...
	 * @throws VisitException
	 */
	public Address[] stopChunk(Space space, Address[] addresses) throws VisitException {
		return stopChunk(space.getSchema(), space.getTable(), addresses);
	}

	/*
	 * (non-Javadoc)
	 * @see com.lexst.visit.naming.home.HomeVisit#stopChunk(java.lang.String, java.lang.String, com.lexst.util.host.Address[])
	 */
	@Override
	public Address[] stopChunk(String db, String table, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { db, table, addresses };
	...
	/* (non-Javadoc)
	 * @see com.lexst.visit.naming.home.HomeVisit#buildTask(java.lang.String, com.lexst.util.host.Address[])
	 */
	public Address[] buildTask(String naming, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] {naming, addresses};
	...
	/* (non-Javadoc)
	 * @see com.lexst.visit.naming.home.HomeVisit#showChunkSize(java.lang.String, int, java.lang.String[])
	 */
	@Override
	public long showChunkSize(String schema, int siteType, Address[] sites) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { schema, new Integer(siteType), sites };
		Object param = super.invoke(HomeClient.methodShowChunkSize1, params);
		return ((Long) param).longValue();
	}

	/* (non-Javadoc)
	 * @see com.lexst.visit.naming.home.HomeVisit#showChunkSize(java.lang.String, java.lang.String, int, java.lang.String[])
	 */
	@Override
	public long showChunkSize(String schema, String table, int siteType, Address[] sites) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { schema, table, new Integer(siteType), sites };
		Object param = super.invoke(HomeClient.methodShowChunkSize2, params);
		return ((Long) param).longValue();
	}
	 ...
	 */
	@Override
	public String showTask(String tag, Address[] addresses) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { tag, addresses };
		Object param = super.invoke(HomeClient.methodShowTask, params);
		return (String) param;
	}
	...
	public boolean sendCodePoints(String compress, byte[] stream) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { compress, stream };
		Object param = super.invoke(HomeClient.methodSendCodePoints, params);
		return ((Boolean) param).booleanValue();
	}
	
	/*
	 * (non-Javadoc)
	 * @see com.lexst.visit.naming.home.HomeVisit#findCodePoints(java.lang.String, java.lang.String)
	 */
	@Override
	public int[] findCodePoints(String schema, String table, short columnId) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { schema, table, new java.lang.Short(columnId) };
		Object param = super.invoke(HomeClient.methodFindCodePoints, params);
		return (int[]) param;
	}
}