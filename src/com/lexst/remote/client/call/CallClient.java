...
public class CallClient extends RemoteClient implements CallVisit {
	...
	private static Method methodConduct;
	...
	static {
		try {
			...
			methodConduct = (CallVisit.class).getMethod("conduct", new Class<?>[] { Conduct.class });
	...
	public int insert(Insert object, boolean sync) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { object, new Boolean(sync) };
	...
	public byte[] conduct(Conduct object) throws VisitException {
		this.refreshTime();
		Object[] params = new Object[] { object };
		Object param = super.invoke(CallClient.methodConduct, params);
		return (byte[]) param;
	}
