...
public class Delete extends Query {
	...
	/** 如果snatch等于TRUE，当存储层删除记录后，返回被删除的记录集合；否则不返回。默认是FALSE */
	...
	public int resolve(byte[] b, int offset, int len) {
		...
		byte method = b[off++];
		if(method != SQLMethod.DELETE_METHOD) {
...
//		delete.setChunkids(this.chunkIds);
