...
public class TimeAttribute extends NumberAttribute {
	 ...
	 * @param attribute
	 */
	public TimeAttribute(TimeAttribute attribute) {
		super(attribute);
	 ...
	 * @param value
	 */
	public TimeAttribute(short columnId, int value) {
		this();
	...
	public com.lexst.sql.column.Column getDefault(short columnId) {
		com.lexst.sql.column.Time column = new com.lexst.sql.column.Time(columnId);
		if (isNullable()) return column;

		if (function != null) {
			column.setValue(SQLFunctionComputer.toTime(function, null));
		} else {
