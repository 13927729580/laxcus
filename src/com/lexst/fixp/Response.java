...
public class Response {
	...
	public final static short SQL_USER = 1011;
	
	public final static short HOME_ISEE = 1020;
	public final static short LIVE_ISEE = 1021;

	public final static short ADDRESS_EXISTED = 1030;
	...
	/** 分布计算应答码  **/
	public final static short CONDUCT_OKAY = 3204;
	public final static short CONDUCT_FAILED = 3205;
	public final static short CONDUCT_SIZENOTMATCH = 3206;
	public final static short CONDUCT_CLIENTERR = 3207;
	public final static short CONDUCT_SERVERERR = 3208;
